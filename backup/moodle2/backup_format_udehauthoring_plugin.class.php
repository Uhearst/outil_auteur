...
class backup_format_udehauthoring_plugin extends backup_format_plugin {
    ...
    protected function define_course_plugin_structure() {
        ...
        // Exploration tools backup

        $exp_tool = new backup_nested_element('udeha_exp_tool', ['id'], [
            'toolid', 'tooltype', 'timemodified'
        ]);
        $exploration_plan->add_child($exp_tool);
        $exp_tool->set_source_table('udehauthoring_exp_tool', ['audehexplorationid' => backup::VAR_PARENTID]);
        ...
        $evaluation_objs->add_child($evaluation_obj);
