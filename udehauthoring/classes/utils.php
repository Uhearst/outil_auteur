...
class utils
{
    ...
    public static function navBar($coursetitle, $courseid, $previewurl) {
        ...
        $nav .= \html_writer::start_tag('button', ['id' => 'preview-button', 'class' => 'btn navbar-btn', 'type' => 'button',
        ...
        $nav .= \html_writer::start_tag('div', ['class' => 'dropdown navbar-btn']);
        $nav .= \html_writer::start_tag('button', ['id' => 'publish-button', 'class' => 'btn dropdown-toggle navbar-btn', 'type' => 'button',
        ...
        $nav .= \html_writer::start_tag('div', ['class' => 'dropdown navbar-btn']);
        $nav .= \html_writer::start_tag('button', ['id' => 'zoom-button', 'class' => 'btn dropdown-toggle navbar-btn', 'type' => 'button',
    ...
    public static function buildMainMenuArray(course_plan $courseplan) {
        ...
        for($i = 0; $i < 3; $i++) {
            if($i == 0) {
                ...
                $obj->subitems = utils::buildCourseItems($courseplan->id);
                $elementArray[] = $obj;
            } else if($i == 1) {
                if ($section_instances) {
